...
(async () => {
    ...
    const data = await TxFetcher.fetchTransaction("452c629d67e41baec3ac6f04fe744b4b9617f8f859c63b3002f8684e7a4fee03");
    const sigHash = (await data.signatureHash(0)).toString('hex')
